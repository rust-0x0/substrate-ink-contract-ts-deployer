...
const basepath = "/Users/lisheng/mygit/rust0x0/hex-space-protocol-substrate/"
...
async function instantiate(acc: String, args: String, code_hash: String, path: String, key: String) {
    ...
    let output = await execCmd('cargo contract instantiate --constructor new ' + (args == undefined || args == "" ? "" : " --args " + args) + '  --storage-deposit-limit 20000000000000000  --suri //' + acc, "Contract ", path);
